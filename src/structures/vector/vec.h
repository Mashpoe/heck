...
#define vector_add_asg(vec_addr)			((typeof(*vec_addr))(_vector_add((vector*)vec_addr, sizeof(**vec_addr))))
#define vector_insert_asg(vec_addr, pos)	((typeof(*vec_addr))(_vector_insert((vector*)vec_addr, sizeof(**vec_addr), pos)))
